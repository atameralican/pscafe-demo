...
import { motion, useAnimation, useInView, Variants, type Transition } from "framer-motion"
    ...
    <section ref={sectionRef} id="testimonials" className={`py-24 overflow-hidden bg-muted/30 ${className || ""}`}>
      <div className="px-4 md:px-6">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="relative h-full ms-4 md:ms-0 mr-10 min-h-[300px] md:min-h-[400px]">
              ...
              >
                <div className="bg-card border shadow-lg rounded-xl p-6 h-full flex flex-col">
                  ...
                  <div className="relative mb-6 flex-1">
                    ...
                    <p className="relative z-10 md:text-base text-xs font-medium leading-relaxed line-clamp-6 md:line-clamp-9 lg:line-clamp-none">
        ...
        {trustedCompanies.length > 0 && (
          <motion.div variants={itemVariants} initial="hidden" animate={controls} className="mt-24 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-x-12 md:gap-y-8 gap-y-2">
